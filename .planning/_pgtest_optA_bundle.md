...
===== FILE: tests/test_rls_isolation.py (cleanup_rows model + crm teardown) =====
...
===== FILE: app.py module-top-level seeders (the baseline) (lines 1125,1145p;1196,1245p;1310,1320p;2120,2135p) =====


===== FILE: database/models.py public tables region (lines 1,30p;505,600p) =====
...
===== FILE: tests/test_ewb_pipeline.py =====
...
===== FILE: tests/test_dashboard_outcome_reminder.py =====
...
===== FILE: tests/test_eur_calculator.py =====
...
===== FILE: PLAN-04-persistenz-haertung =====
---
phase: 08.23.2.PGTEST
plan: 04
type: execute
