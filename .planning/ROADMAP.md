...
**Status:** ✅ **GEBAUT + BEIDE BELEGE ERBRACHT 2026-07-31** (4/4 Pläne, HEAD `f1eb9ed`, gepusht, **NICHT deployt**) → nächster Schritt: **Claudian fährt `bash deploy.sh production` + Test-Anruf**. Kein Deploy durch GSD.
