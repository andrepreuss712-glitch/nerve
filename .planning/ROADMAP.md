...
- [~] 08.23.2.TAXO2.HANDLING-TIMING-05-preview-und-checkpoint-PLAN.md — Preview „Beobachtung statt Zahl“ + Fuzzy-beleg_check (Task 1+2 GEBAUT 2026-06-28) — OFFEN: D-RESIDENZ-Entscheidung (Task 3) + finaler BLOCKENDER supervised Deploy/Live-Test/halluzinierte-Belege-Check (Task 4, autonomous:false) [W5]
