...
### Phase 08.23.2.CALLID: intent_event.call_id durchreichen + Integrität (INSERTED 2026-06-25) 🔴 — 🔨 DEPLOY 1 GEBAUT 2026-06-25 (Plan 01+02+03), STOP vor Deploy, Plan 04=Deploy 2 offen
...
- [ ] 08.23.2.CALLID-04-notnull-migration-cleanup-PLAN.md — W3/Deploy2 (autonomous:false, gated by SOAK V-CI-6): **NICHT gebaut** (Deploy 2 NACH Soak) — Pre-Check (alle NULL=='failed', sonst STOP) → DELETE 54 NULL → intent_event.call_id SET NOT NULL + models.py (CI-3)
