...
>
> **Reihenfolge ab hier (Vault-Roadmap "WO STEHEN WIR" ist fuehrend):** SCHWAERZ-1 → "Verstehe"-Fix → METRIK-1 → Schwaerzung-Mittelweg (Beschluss D) → Schott-Restpaket → Stresstest.
