...
**Status:** 🟡 RESCOPED 2026-06-28, Replan läuft (Plan → Cross-AI/Gemini → Pre-Execute-Audit → Execute). CONTEXT.md neu für den Judge; alte Anker-RESEARCH/-Pläne als überholt markiert.

**Plans:** TBD (Replan 2026-06-28 — LLM-Bewerter; alte Anker-Pläne 01/02 ersetzt).
