...
def test_seed_idempotent(db_session):
    _seed_prompt_versions(db_session)
    # scope-fix (Gemini-3.1-Pro-Fold #3): app-import committet prompt_versions
    # (_seed_prompt_versions=4; der ewb-Seeder _seed_ewb_v2 ist in Welle 6 entfernt) in die
    # persistente nerve_test (D-03) -> globale count waere fragil. Auf EXPECTED_MODULES gescoped.
